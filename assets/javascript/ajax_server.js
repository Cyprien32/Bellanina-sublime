...
$(document).ready(function(){
	...
	function lanceFiltreAdmin(){
		...
		$.ajax({
			url : 'http://localhost/bella_nina/Finder/filtreAdmin',
			method:'post',
			data : $data,
			dataType:'json',
			...
			success : function(data){
				...
				for (var i = 0; i < data['data']['total']; i++) {
					$div =  '<a href="http://localhost/bella_nina/Administration/viewAdminProfil/'+data['data'][i]['id_admin']+'" > ';
				    ...
				    $div +=	'		                    <img class="img-circle" src="http://localhost/bella_nina/assets_al/images/images_admin/images/'+data['data'][i]['image']+'" alt="User Avatar">';
				    $div +=	'		                  </div>';
	...
	function lanceFiltreCaissier(){
		...
		// appel de la fonction ajax
		$.ajax({
			url : 'http://localhost/bella_nina/Finder/filtreCaissier',
			method:'post',
			data : $data,
			dataType:'json',
			...
			success : function(data){
				...
				for (var i = 0; i < data['data']['total']; i++) {
					$div =  '<a href="http://localhost/bella_nina/Administration/viewCaissierProfil/'+data['data'][i]['id_caissier']+'" > ';
				    $div += '   <div class="col-md-4">';
				    $div += '      <!-- Widget: user widget style 1 -->'
				    $div +=	'	      <div class="box box-widget widget-user">';
				    $div +=	'		                  <!-- Add the bg color to the header using any of the bg-* classes -->';
				    ...
				    $div +=	'		                  </div>';
				    $div +=	'		                  <div class="widget-user-image">';
				    $div +=	'		                    <img class="img-circle" src="http://localhost/bella_nina/assets_al/images/images_caissier/images/'+data['data'][i]['image']+'" alt="User Avatar">';
				    $div +=	'		                  </div>';
				    $div +=	'		                  <div class="box-footer">';
				    $div +=	'		                    <div class="row">';
				    $div +=	'		                      <div class="col-sm-4 border-right">';
	...
	function lanceFiltreClient(){
		...
		// appel de la fonction ajax
		$.ajax({
			url : 'http://localhost/bella_nina/Finder/filtreClient',
			method:'post',
			data : $data,
			dataType:'json',
			...
			success : function(data){
				...
				for (var i = 0; i < data['data']['total']; i++) {
					$div =  '<a href="http://localhost/bella_nina/Administration/viewClientProfil/'+data['data'][i]['id_client']+'" > ';
				    $div += '   <div class="col-md-4">';
				    $div += '      <!-- Widget: user widget style 1 -->'
				    $div +=	'	      <div class="box box-widget widget-user">';
				    $div +=	'		                  <!-- Add the bg color to the header using any of the bg-* classes -->';
				    ...
				    $div +=	'		                  </div>';
				    $div +=	'		                  <div class="widget-user-image">';
				    $div +=	'		                    <img class="img-circle" src="http://localhost/bella_nina/assets_al/images/images_client/images/'+data['data'][i]['image']+'" alt="User Avatar">';
				    $div +=	'		                  </div>';
				    $div +=	'		                  <div class="box-footer">';
				    $div +=	'		                    <div class="row">';
				    $div +=	'		                      <div class="col-sm-4 border-right">';
