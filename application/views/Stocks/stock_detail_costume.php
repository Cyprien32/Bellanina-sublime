		        ...
		        <form method="post" action="<?php echo site_url(array('Stock','postArticle')); ?>">
		            ...
		            <div class="vali-form">
		            	<div class="col-md-2 form-group1">
			              ...
			              <input value="00" class="form-control" min="0" name="qteT44" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 45</label>
			              <input value='00' class="form-control" min="0" name="qteT45" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 46</label>
			              <input value="00" class="form-control" min="0" name="qteT46" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 47</label>
			              <input value="00" class="form-control" min="0" name="qteT47" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 48</label>
			              <input value="00" class="form-control" min="0" name="qteT48" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 49</label>
			              <input value="00" class="form-control" min="0" name="qteT49" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 50</label>
			              <input value="00" class="form-control" min="0" name="qteT50" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 51</label>
			              <input value="00" class="form-control" min="0" name="qteT51" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 52</label>
			              <input value="00" class="form-control" min="0" name="qteT52" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 53</label>
			              <input value="00" class="form-control" min="0" name="qteT53" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 54</label>
			              <input value="00" class="form-control" min="0" name="qteT54" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 55</label>
			              <input value="00" class="form-control" min="0" name="qteT55" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 56</label>
			              <input value="00" class="form-control" min="0" name="qteT56" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 57</label>
			              <input value="00" class="form-control" min="0" name="qteT57" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 58</label>
			              <input value="00" class="form-control" min="0" name="qteT58" type="number">
			            </div>
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 59</label>
			              <input value="00" class="form-control" min="0" name="qteT59" type="number">
			            </div> 
			            <div class="col-md-2 form-group1">
			              <label class="control-label">Taille 60</label>
			              <input value="00" class="form-control" min="0" name="qteT60" type="number">
			            </div>
			            <div class="clearfix"> </div>
			        </div>
		...
		<div class="modal-content">
			...
			<form  method="post" action="<?php echo site_url(array('Stock','addMarque')); ?>" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="modal-footer">
					...
					<input type="submit" value="Ajouter" class="btn btn-success" id="savemarque" >
				</div>
			</form>
		</div>
	</div>
